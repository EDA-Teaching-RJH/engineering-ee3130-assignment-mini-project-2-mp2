import pytest
from driving_center_data import email, secret_code, missing_student, student_data
def main():
    test_email()
    test_code()
...
def test_email():
    try:
        assert email("rAMya@gmail.com") == "rAMya@gmail.com"
        assert email("Ramya325@gmail.com") == "Ramya325@gmail.com"
...
def test_code():
    try:
        ...
        assert secret_code('23') == "You entered the right code! You can access the data."
